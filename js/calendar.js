...
const selectedFateText = document.getElementById("selectedDateText");
const timeSlot = document.getElementById("timeSlosts");

const bookingForm = document.getElemtntById("bookingForm");
...
const formateReadableDate = (year, month, day) => {
...
const isPastDue = (year, month, day) => {
...
const usClosedDay = (year, month, day) => {
    const date = new Date(year, month, day);
...
const renderTimeSlots = () => {
    ...
    if (!selectedDate) {
        timeSlots.innetHTML = `<p class="selected-date-text">Choose a date first.</p>`;
        return;
    }
...
bookingForm.addEventListener("submit", (event) => {
    ...
    if (bookedApointedments[selectedDate.key].includes(timeValue)) {
